...
What started as a bug, became a fun easter egg. When the variable of the size is smaller than zero, the chess pieces reverse their direction and turn upside down. To underline that, I wrote a if statement, that in this specific case the background shall be negative.
<br/><br/><br/>
